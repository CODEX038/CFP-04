...
const LandingPage = () => {
  ...
  const steps = [
    {
      ...
      desc: "Link MetaMask to get started — no sign-up required.",
    },
    {
      num: "02",
      title: "Create or browse",
      desc: "Launch a campaign or explore active ones looking for backers.",
    },
    {
      num: "03",
      title: "Fund & track",
      desc: "Send ETH directly to the smart contract and watch progress in real time.",
    },
    {
      num: "04",
      title: "Withdraw or refund",
      desc: "Goals met? Withdraw funds. Deadline passed without goal? Claim your refund.",
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Admins are appointed by the platform. Click "Admin" in the navbar and use your credentials to log in.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-1">
            <button
              ...
              className="px-4 py-2 text-sm text-gray-600 hover:text-gray-900 font-medium transition-colors rounded-lg hover:bg-gray-50"
            >
              Browse campaigns
            </button>
            <button
        ...
        <div className="mt-16 bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl p-8 max-w-4xl mx-auto border border-purple-100">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={i}
                className="bg-white rounded-2xl p-4 text-left border border-purple-100"
              >
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Built on Ethereum — transparent, permissionless, and fully
            decentralized.
          </p>
        </div>
      ...
      <section className="bg-gray-50 py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              From wallet connect to withdrawal — four simple steps.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((s, i) => (
              <div key={i} className="relative">
                <div className="bg-white rounded-2xl p-6 border border-gray-100 h-full">
                  <span className="text-4xl font-bold text-purple-100 mb-4 block">
                    {s.num}
                  </span>
      ...
      <section className="max-w-3xl mx-auto px-6 py-24">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500">
            Everything you need to know about FundChain.
          </p>
        </div>
          ...
          {faqs.map((faq, i) => (
            ...
            >
              ...
              >
                ...
                <span
                  className={`text-purple-600 text-lg transition-transform ${openFaq === i ? "rotate-45" : ""}`}
                >
                  +
                </span>
              </button>
      ...
      <section className="bg-purple-600 py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-purple-200 mb-8 max-w-xl mx-auto">
            Launch your campaign today — no sign-up, no approval, no
            gatekeepers.
          </p>
          <button
            onClick={() => navigate("/app")}
      ...
      <footer className="border-t border-gray-100 py-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-sm text-gray-400">
            ...
            <a
              href="https://github.com/Patil-K-Bhushan/crowdfunding-dapp"
              target="_blank"
              rel="noreferrer"
              className="hover:text-gray-600"
            >
          ...
          <p className="text-xs text-gray-400">
            © 2026 FundChain. Built on Ethereum.
          </p>
        </div>
      </footer>
    </div>
